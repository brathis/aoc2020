...
def part_02():
    ...
    # Load the initial state (z=0, w=0).
    ...
    for _ in range(NUM_ITER):
        ...
        min_x, min_y, min_z, min_w = None, None, None, None
        max_x, max_y, max_z, max_w = None, None, None, None
